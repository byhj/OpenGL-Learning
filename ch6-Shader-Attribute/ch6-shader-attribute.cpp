...
const static GLsizei VertexCount(6);
...
void init_vertexArray()
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(glm::vec3) * 2, (GLvoid*)(NULL));
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(glm::vec3) * 2, (GLvoid*)(NULL + sizeof(glm::vec3)) );
