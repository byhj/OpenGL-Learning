...
void WindowApp::v_Render()
{
	...
	RenderText(program, "(C) LearnOpenGL.com", 600.0f, 600.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f));

};

void WindowApp::init_shader()
{
	...
	glm::mat4 projection = glm::ortho(0.0f, static_cast<GLfloat>(GetScreenWidth()), 
		                              0.0f, static_cast<GLfloat>(GetScreenHeight()));
	glUniformMatrix4fv(glGetUniformLocation(program, "projection"), 1, GL_FALSE, &projection[0][0]);

}

void WindowApp::init_buffer()
{
