...
#pragma endregion
	...
	void Plane::Render(byhj::MvpMatrix matrix, const byhj::Camera &camera)
	{
		...
		glBindTexture(GL_TEXTURE_2D, gamma ? woodTexGamma : woodTex);
		...
		glUniform1i( glGetUniformLocation( program,  "gamma"), gamma);
	...
	void Plane::init_texture()
	{
		...
		woodTexGamma = loadTextureGamma("../../../media/textures/wood.png", true);
	}
