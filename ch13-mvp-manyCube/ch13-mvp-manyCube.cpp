...
void render()
{
    ...
    for(GLuint i = 0; i < 10; i++) {
		...
		glm::mat4 view_matrix = glm::lookAt(glm::vec3(0.0, 0.0, 3.0), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 1.0, 0.0));
		glm::mat4 proj_matrix = glm::perspective(45.0f, 720.0f / 640.0f, 0.1f, 1000.0f);
		model = proj_matrix * view_matrix * model;
		glUniformMatrix4fv(mvp_matrix_loc, 1, GL_FALSE, &model[0][0]);
