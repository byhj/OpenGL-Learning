...
{
	TriangleShader.init();
	TriangleShader.attach(GL_VERTEX_SHADER, "container.vert");
	TriangleShader.attach(GL_FRAGMENT_SHADER, "container.frag");
	TriangleShader.link();
...
{		
	...
	init_buffer();
	init_vertexArray();
	textureID = init_texture("../media/Texture/container.jpg");
}
...
int main()
{
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glBindVertexArray(vao);
		glUniform1i(glGetUniformLocation(program, "container"), 0);
